...
if os.path.exists('./TrainedModels/Transformer/gold_model.keras'):
    print("Model file exists. Loading model...")
    from tensorflow.keras.models import load_model
    model = tf.keras.models.load_model(
        './TrainedModels/Transformer/gold_model.keras', 
    ...
    checkpoint = ModelCheckpoint('./TrainedModels/Transformer/gold_model.keras', monitor='val_loss', save_best_only=True)
