...
if os.path.exists('./TrainedModels/Transformer/natgas_model.keras'):
    print("Model file exists. Loading model...")
    from tensorflow.keras.models import load_model
    model = tf.keras.models.load_model(
        './TrainedModels/Transformer/natgas_model.keras', 
    ...
    checkpoint = ModelCheckpoint('./TrainedModels/Transformer/natgas_model.keras', monitor='val_loss', save_best_only=True)
